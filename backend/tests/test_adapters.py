...
json_postal_break = {'type': 'hotel-offers', 'hotel': {'type': 'hotel', 'hotelId': 'AMJAIAAK', 'chainCode': 'AM', 'dupeId': '700035202', 'name': 'Aman-i-Khas', 'rating': '5', 'cityCode': 'JAI', 'latitude': 26.01736, 'longitude': 76.4556, 'address': {'lines': ['RANTHAMBHORE', 'RAJASTHAN'], 'cityName': 'RANTHAMBHORE', 'countryCode': 'IN', 'stateCode': 'RJ'}, 'contact': {'phone': '91-7462-252052', 'fax': '91-7462-252178', 'email': 'aman-i-khas@aman.com'}, 'description': {'lang': 'en', 'text': 'A wilderness location and a sensitive connection to Rajasthans history and culture await guests at Aman-i-Khas an outpost on the threshold of Ranthambore National Park inspired by lavish Mughal hunting parties of old. Each of the ten soaring guest tents is beautifully furnished and assigned a personal butler. In-between daily Jeep safaris to catch a glimpse of tigers and other wildlife guests can enjoy rejuvenating spa treatments or a dip in the traditional step-well pool before drinks around a communal firepit and dinners lit by flickering candles under a canopy of stars.\rTraditional treatments as well as Reiki healing - body scrubs and facials soothe and revive in the spa tent.\rMade with vegetables and herbs grown in the camps organic garden Indian and western dishes are served in the softly-lit dining tent.\rWhether it is a landmark celebration or a group retreat Aman-i-Khas offers an opportunity for a memorable wilderness escape.'}, 'amenities': ['FEMA_FIRE_SAFETY_COMPLIANT', 'FIRST_AID_STAF', 'RESTAURANT', 'LOUNGE', 'MASSAGE', 'OUTDOOR_POOL', 'SPA', 'CAR_RENTAL', 'PARKING', 'VALET_PARKING', 'ROOM_SERVICE', 'INTERNET_SERVICES', 'FREE_INTERNET', 'INTERNET_HOTSPOTS', 'WIFI', 'WIRELESS_CONNECTIVITY'], 'media': [{'uri': 'https://d2573qu6qrjt8c.cloudfront.net/440C93E270674E02ADE6C0A1D25500B3/440C93E270674E02ADE6C0A1D25500B3.JPEG', 'category': 'RESTAURANT'}]}, 'available': True, 'offers': [{'id': '3NC3TC5VMF', 'checkInDate': '2021-03-02', 'checkOutDate': '2021-03-03', 'rateCode': 'RAC', 'rateFamilyEstimated': {'code': 'RAC', 'type': 'P'}, 'commission': {'percentage': '10.00'}, 'boardType': 'FULL_BOARD', 'room': {'type': 'A1K', 'typeEstimated': {'beds': 1, 'bedType': 'KING'}, 'description': {'text': 'DAILY RATE INCL FULL BOARD \nTent-King or Twin-108sqm-1162sqft-Free Wifi-Garden view-\nOversized daybed for lounging Dining area-Twin writing desks-\nBathing area with shower-Bathtub-Separate toilet-Dressing area-\nTwin vanities-Sundeck-Air conditioning-Ceiling fan-Heating-Chest\ncooler for drinks ', 'lang': 'EN'}}, 'guests': {'adults': 1}, 'price': {'currency': 'USD', 'total': '1557.60', 'variations': {'average': {'base': '1200.00'}, 'changes': [{'startDate': '2021-03-02', 'endDate': '2021-03-03', 'base': '1200.00'}]}}, 'policies': {'deposit': {'deadline': '2021-02-05T00:00:00', 'acceptedPayments': {'creditCards': ['VI', 'CA', 'AX'], 'methods': ['CREDIT_CARD']}}, 'paymentType': 'deposit', 'cancellation': {'amount': '1557.60', 'deadline': '2021-01-31T00:00:00+05:30'}}}], 'self': 'https://api.amadeus.com/v2/shopping/hotel-offers/by-hotel?hotelId=AMJAIAAK&checkInDate=2021-03-02&checkOutDate=2021-03-03'}
